...
DECISIONES_ADOPTADAS = [
 ...
 ("B12", "Cobertura declarada de cada plataforma",
  "SECOP I y SECOP II se sincronizan por separado y la interfaz declara qué cubre cada una y cuándo se actualizó. Una plataforma no sincronizada se muestra como tal: presentarla como «sin resultados» haría creer que una oportunidad no existe cuando solo falta actualizarla. Verificado con datos reales: SECOP I expone 78 campos frente a los 59 de SECOP II, con esquemas distintos que no se fuerzan a equivaler. Medición del solapamiento (2026-09-18): **12 de 12 procesos recientes de SECOP I ya están en SECOP II**, así que sincronizar SECOP I no aporta oportunidades nuevas. La épica E12 baja de prioridad: se conserva como contrato de arquitectura multi-fuente, que es barato ahora y caro después, pero no se construye el conector en el MVP."),
...
FASES = [
 ...
 ("F3", "Origen multi-fuente (sin conector de SECOP I)", "2 días",
  "Preservar el origen por oportunidad y declarar la cobertura real, en lugar de construir un conector de SECOP I que no aporta oportunidades nuevas: 12 de 12 procesos recientes de SECOP I ya están en SECOP II. La arquitectura queda preparada para añadirlo si aparece evidencia de lo contrario, sin migración.",
...
RIESGOS = [
 ...
 ("Mediciones sesgadas por el orden de consulta",
  "Ya ocurrió dos veces: ordenar por un campo con valores nulos devuelve primero las filas sin ese campo. La primera medición del solapamiento SECOP I/II dio 2 coincidencias de 297 y era falsa; la medición fiable es la consulta cruzada directa, que no depende del orden. Registrar el método junto al resultado.", "Media"),
